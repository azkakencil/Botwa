...
module.exports = Cantarella = async (Cantarella, m, chatUpdate, store) => {
    try {
        const body = (
        ...
        const sender = m.key.fromMe ? Cantarella.user.id.split(":")[0] + "@s.whatsapp.net" || Cantarella.user.id
: m.key.participant || m.key.remoteJid;
        ...
        const botNumber = await Cantarella.decodeJid(Cantarella.user.id);
        ...
        const Cantarelladev = (m && m.sender && [botNumber, ...global.owner].map(v => v.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(m.sender)) || false;
        ...
        const groupMetadata = isGroup ? await Cantarella.groupMetadata(m.chat).catch((e) => {}) : "";
...
buttons: [
  ...
  viewOnce: true,
image: { url: thumbnail },
caption: `✨ ʜᴀʟᴏ ${pushname} 👋  
ɴᴀᴍᴀ sᴀʏᴀ ${namaBot} — ʙᴏᴛ ᴡʜᴀᴛsᴀᴘᴘ  
ʏᴀɴɢ ᴅɪᴋᴇᴍʙᴀɴɢᴋᴀɴ ᴏʟᴇʜ ${namaowner}.  
sᴀʏᴀ sɪᴀᴘ ᴍᴇᴍʙᴀɴᴛᴜ ᴍᴜ ᴅɪ ᴋᴀᴘᴀɴᴘᴜɴ & ᴅɪᴍᴀɴᴀᴘᴜɴ 🤖💫

╭━━━〔 🌐 ɪɴᴛʀᴏ ʙᴏᴛ 〕━━━━╮
┃ ✨ ʙᴏᴛ ᴍᴜʟᴛɪ-ᴅᴇᴠɪᴄᴇ
┃ 🛠️ ᴅɪʙᴜᴀᴛ ᴏʟᴇʜ : ${namaowner}
┃ 🚀 sɪᴀᴘ ʙᴇʀᴏᴘᴇʀᴀsɪ 24/7
╰━━━━━━━━━━━━━━━━━━━━╯

╭━━━〔 📘 ɪɴғᴏ sɪsᴛᴇᴍ 〕━━━━╮
┃ 👑 ᴄʀᴇᴀᴛᴏʀ : ${namaowner}
┃ ⚙️ ꜱᴄʀɪᴘᴛ   : ᴘʀᴇᴍɪᴜᴍ ᴍᴏᴅᴜʟᴇ
┃ 🧩 ᴏᴘᴛɪᴍᴀꜱɪ : ғᴀsᴛ, sᴛᴀʙʟᴇ, ʟɪɢʜᴛ
╰━━━━━━━━━━━━━━━━━━━━╯

╭━━━〔 💎 ᴋᴇᴜɴɢɢᴜʟᴀɴ ʙᴏᴛ 〕━━━━╮
┃ • ⚡ ғᴀsᴛ ʀᴇsᴘᴏɴ & sᴛᴀʙɪʟ  
┃ • 📚 ғɪᴛᴜʀ ᴛᴇʀᴜᴘᴅᴀᴛᴇ sᴇᴛɪᴀᴘ ᴠᴇʀsɪ
┃ • 🧠 ʀɪɴɢᴀɴ, ᴛɪᴅᴀᴋ ʙᴏʀᴏs ʀᴀᴍ/ᴄᴘᴜ  
┃ • 🛡️ sᴛᴀʙɪʟ ᴅɪ sᴇᴍᴜᴀ ᴅᴇᴠɪᴄᴇ
┃ • 🎨 ʙɪsᴀ ᴄᴜsᴛᴏᴍ ᴘᴇʀɪʟᴀᴋᴜ ʙᴏᴛ
┃ • 🌙 24/7 ᴏɴʟɪɴᴇ ᴛᴀɴᴘᴀ ɢᴀɴɢɢᴜᴀɴ
╰━━━━━━━━━━━━━━━━━━━━╯
${teks}`,
contextInfo:{
mentionedJid:[sender],
...
newsletterJid: idch,
newsletterName: `ᴄᴀɴᴛᴀʀᴇʟʟᴀ || カンタータ`,
serverId: 200
}, 
externalAdReply: {
title: `© ${namaBot}`, 
...
mediaType: 0, 
previewType: 0, 
sourceUrl: "https://Cantarellas-store.vercel.app", 
}}
}, {quoted: m })
}
//
...
//theme sticker reply
        const Cantarellawet = () => {
        let CantarellaStickRep = fs.readFileSync('./lib/sticker_reply/wait.webp')
        Cantarella.sendMessage(from, { sticker: CantarellaStickRep }, { quoted: m })
        }
        const Cantarellaadmn = () => {
        let CantarellaStickRep = fs.readFileSync('./lib/sticker_reply/admin.webp')
        Cantarella.sendMessage(from, { sticker: CantarellaStickRep }, { quoted: m })
        }
        const Cantarellabotadmin = () => {
        let CantarellaStickRep = fs.readFileSync('./lib/sticker_reply/botadmin.webp')
        Cantarella.sendMessage(from, { sticker: CantarellaStickRep }, { quoted: m })
        }
        const Cantarellaowner = () => {
        let CantarellaStickRep = fs.readFileSync('./lib/sticker_reply/owner.webp')
        Cantarella.sendMessage(from, { sticker: CantarellaStickRep }, { quoted: m })
        }
        const Cantarellaongb = () => {
        let CantarellaStickRep = fs.readFileSync('./lib/sticker_reply/group.webp')
        Cantarella.sendMessage(from, { sticker: CantarellaStickRep }, { quoted: m })
        }
        const Cantarellapriv = () => {
        let CantarellaStickRep = fs.readFileSync('./lib/sticker_reply/prem.webp')
        Cantarella.sendMessage(from, { sticker: CantarellaStickRep }, { quoted: m })
        }
        let cihuy = thumbnail
        if (m.message) {
            console.log(
            chalk.gray("┌─") +
            chalk.cyan.bold(" Console By FallZx Infinity ") +
            chalk.gray("─────────────────┐")
            );
            console.log(
            chalk.gray("│ ") +
            chalk.yellow(`Tanggal   : ${new Date().toLocaleString()} \n`) +
            chalk.gray("                                               │")
            );
            console.log(
            chalk.gray("│ ") +
            chalk.yellow(`Pesan     : ${m.body || m.mtype} \n`) +
            chalk.gray("                                               │")
            );
            console.log(
            chalk.gray("│ ") +
            chalk.yellow(`Pengirim  : ${pushname} \n`) +
            chalk.gray("                                               │")
            );
            console.log(
            chalk.gray("│ ") +
            chalk.yellow(`Jid  : ${senderNumber}`) +
            chalk.gray("                         │")
            );
            console.log(
            chalk.gray("└─") +
            chalk.magenta.italic(" Cantarella MD V1.0 ") +
            chalk.gray("─────────────────────────┘")
            );
...
return await Cantarella.groupParticipantsUpdate(m.chat, [m.sender], 'remove')
}
}
...
if (
  ...
  if (isPossibleBot) {
    ...
    if (warnCount <= 2) { // max warn ubah ae
      await Cantarella.sendMessage(groupId, {
        text: `⚠️ *Antibot aktif!*\nBot tidak diizinkan di grup ini!\nPeringatan ke-${warnCount}/3`,
        mentions: [sender]
      })
      await Cantarella.sendMessage(groupId, { delete: m.key }).catch(() => {})
    } else {
      await Cantarella.sendMessage(groupId, {
        text: `Bot @${sender.split('@')[0]} telah dikeluarkan dari grup karena melanggar aturan.`,
        mentions: [sender]
      })
      await Cantarella.groupParticipantsUpdate(groupId, [sender], 'remove').catch(() =>
        Cantarella.sendMessage(groupId, { text: '⚠️ Gagal kick bot. Mungkin bot bukan admin.' })
      )
...
//
   ...
   const fitur1 = () =>{
            var mytext = fs.readFileSync("./Cantarella.js").toString()
...
if (command) { Cantarella.readMessages([m.key])}
Cantarella.sendPresenceUpdate('composing', from)
}
if (global.autoread) {
Cantarella.readMessages([m.key])
        };
...
Cantarella.enhancer = Cantarella.enhancer ? Cantarella.enhancer : {};
        
Cantarella.autoshalat = Cantarella.autoshalat ? Cantarella.autoshalat : {}
    let id = m.chat
    if (id in Cantarella.autoshalat) {
    return false
    }
    let jadwalSholat = {
    shubuh: '04:29',
...
contextInfo: {
    externalAdReply: {
        ...
        body: `🕑 ${waktu}`,
        sourceUrl: '',
        thumbnailUrl: "https://img1.pixhost.to/images/6601/612882514_Cantarella.jpg",
        renderLargerThumbnail: true
    }
}
            }, {}),
            setTimeout(async () => {
delete Cantarella.autoshalat[m.chat]
            }, 5000)
        ]
    }
    }
...
global.menfess = global.menfess ? global.menfess : {}
         ...
         if (mf && body) {
          ...
          //  if (!/conversation|extended/.test(m.type)) return reply(`Balas dengan teks biasa.`)
            ...
            await Cantarella.sendMessage(mf.from, { text: text }).then(async () => {
    ...
    try {
        ...
        const logic = "kamu adalah Xenovia ai, asisten ai yang di buat oleh Cantarella, kamu bisa mempromosikan link group https://chat.whatsapp.com/FKLOiDRsK4T9DcSvFGxNBx tetapi agak jarang saja jangan terlalu sering mempromosikan nya, kamu adalah asisten ai cerdas yang cantik dan ramah kamu suka emot 🐱😄😆, jangan sering menyapa orang, dan kamu bisa bahasa Jepang tapi jangan kebanyakan jepang";
...
//Plugin
const handleData = { Cantarella, text, args, isCmd, mime, qmsg, isOwner, command, reply }
if (isCmd) {
...
//============= [ COMMANDS ] ====================================================
        switch (command) {
case 'owner': {
 let name = m.pushName || Cantarella.getName(m.sender);
let panduan = foother
    ...
    viewOnceMessage: {
      message: {
        interactiveMessage: {
          ...
          ...(await prepareWAMessageMedia({ image: { url: `${global.thumbnail}` } }, { upload: Cantarella.waUploadToServer })),
          gifPlayback: false,
...
await Cantarella.relayMessage(msg.key.remoteJid, msg.message, {
...
case "menu": {
let me = m.sender
menureply(`*\`ɢᴜɴᴀᴋᴀɴ ᴅᴇɴɢᴀɴ ʙɪᴊᴀᴋ ʏᴀ 💫\`*`)
}
break
case "menuall": {
let me = m.sender
...
const code = fs.readFileSync('Cantarella.js', 'utf8');
...
${prefix + command} https://whatsapp.com/channel/xxx/123 😂 😱`)
    ...
    await Cantarella.sendMessage(m.chat, { react: { text: '⏳', key: m.key } })
...
let media = await downloadContentFromMessage(msg, msg.mimetype == 'image/jpeg' ? 'image' : msg.mimetype == 'video/mp4' ? 'video' : 'audio')
    ...
    if (/video/.test(type)) {
        return Cantarella.sendMessage(m.chat, {video: buffer, caption: msg.caption || ""}, {quoted: m})
    } else if (/image/.test(type)) {
        return Cantarella.sendMessage(m.chat, {image: buffer, caption: msg.caption || ""}, {quoted: m})
    } else if (/audio/.test(type)) {
        return Cantarella.sendMessage(m.chat, {audio: buffer, mimetype: "audio/mpeg", ptt: true}, {quoted: m})
    } 
}
break
case 'listgc': {
 ...
 try {
 const getGroups = await Cantarella.groupFetchAllParticipating();
...
Cantarella.sendMessage(m.chat, {text: teks, mentions: owner}, {quoted: m})
}
break
...
let id = await Cantarella.groupAcceptInvite(result)
...
Cantarella.sendMessage(m.chat, {text: teks, mentions: premium}, {quoted: qkontak})
}
break
case "addprem": {
if (!isOwner) return reply(mess.owner)
...
case "public":{
if (!isOwner) return reply(mess.owner)
Cantarella.public = true
reply(`successfully changed to ${command}`)
}
break
case "self":{
if (!isOwner) return reply(mess.owner)
Cantarella.public = false
reply(`successfully changed to ${command}`)
}
break
case 'delppbot': {
if (!isOwner) return reply(mess.owner)
await Cantarella.removeProfilePicture(Cantarella.user.id)
...
var medis = await Cantarella.downloadAndSaveMediaMessage(quoted, 'ppbot.jpeg')
if (text == 'full') {
var {
img
} = await generateProfilePicture(medis)
await Cantarella.query({
tag: 'iq',
attrs: {
to: botNumber,
type: 'set',
...
var memeg = await Cantarella.updateProfilePicture(botNumber, {
url: medis
})
fs.unlinkSync(medis)
reply(mess.done)
...
if (!args[0]) return m.reply(`Contoh: ${prefix+command} on/off`)
 ...
 if (text === "on") {
 Cantarella.autoshalat[sender] = {
 messages: []
 };
 m.reply(`[ ✓ ] sukses mode*\`Auto-Sholat\`* : ᴀᴋᴛɪғ`);
 } else if (text === "off") {
 delete Cantarella.autoshalat[sender];
...
var onWa = await Cantarella.onWhatsApp(input.split("@")[0])
if (onWa.length < 1) return m.reply("Nomor tidak terdaftar di whatsapp")
const res = await Cantarella.groupParticipantsUpdate(m.chat, [input], 'remove')
...
if (!isGroup) return reply(mess.group);
if (!isBotAdmins) return reply(mess.botadmin)
const urlGrup = "https://chat.whatsapp.com/" + await Cantarella.groupInviteCode(m.chat)
var teks = `
${urlGrup}
`
await Cantarella.sendMessage(m.chat, {text: teks, matchedText: `${urlGrup}`}, {quoted: m})
}
...
if (!isGroup) return reply(mess.group);
if (!isBotAdmins) return reply(mess.botadmin)
await Cantarella.groupRevokeInvite(m.chat)
...
if (!isGroupAdmins && !isOwner) return reply(mess.admin)
if (!isGroup) return reply(mess.group);
 let users = participants.map(u => u.id).filter(v => v !== Cantarella.user.jid)
 if (!m.quoted) return reply(`✳️ Reply to a message`)
 Cantarella.sendMessage(m.chat, { forward: m.quoted.fakeObj, mentions: users } )
}
break
case 'closetime':
if (!isGroupAdmins && !isOwner) return reply(mess.admin)
...
Cantarella.groupSettingUpdate(from, 'announcement')
reply(close)
}, timer)
break
...
Cantarella.groupSettingUpdate(m.chat, 'not_announcement')
reply(open)
}, timer)
}
...
await Cantarella.groupParticipantsUpdate(m.chat, [target], action.toLowerCase()).then(async () => {
await Cantarella.sendMessage(m.chat, {text: `Sukses ${action.toLowerCase()} @${target.split("@")[0]}`, mentions: [target]}, {quoted: m})
})
} else {
...
if (!isGroup) return reply(mess.group);
if (!isBotAdmins) return reply(mess.botadmin)
await Cantarella.removeProfilePicture(from)
}
break
case 'setppgc':
if (!isGroupAdmins && !isOwner) return reply(mess.admin)
...
var memeg = await Cantarella.updateProfilePicture(m.chat, {
url: medis
})
fs.unlinkSync(medis)
reply(mess.done)
...
const groupMetadata = await Cantarella.groupMetadata(m.chat);
...
`
await Cantarella.sendMessage(orang, {text: teks}, {quoted: m})
}
break
...
await Cantarella.sendMessage(m.chat, {text: teks}, {quoted: m})
}
break
...
await Cantarella.sendMessage(m.chat, {text: messageText}, {quoted: m})
}
break
...
let response = await CatBox(media);
  await Cantarella.sendMessage(m.chat, {image: {url: `https://api.siputzx.my.id/api/iloveimg/blurface?image=${response}` }, caption: foother }, {quoted: m})
}
break
...
case "imgbing": case "bingimg": {
    ...
    try {
        await Cantarella.sendMessage(from, { react: { text: "⏳", key: m.key } });
        ...
        for (let img of data.data.result) {
            await Cantarella.sendMessage(from, { image: { url: img }, caption: "Maaf Jika Tidak Sesuai 😌" }, { quoted: m });
        }
        await Cantarella.sendMessage(from, { react: { text: "✅", key: m.key } });
    } catch (error) {
        console.error(error);
...
case 'toreal': {
  try {
    ...
    const media = await Cantarella.downloadAndSaveMediaMessage(quoted)
    ...
    await Cantarella.sendMessage(m.chat, { image: { url: apiUrl } }, { quoted: m })
  } catch (err) {
      ...
      case "tt":
        {
          ...
          await tiktokDl(q).then(async result => {
            ...
            if (result.durations == 0 && result.duration == "0 Seconds") {
              ...
              await Cantarella.relayMessage(m.chat, msgii.message, {
...
await Cantarella.sendMessage(m.chat, {video: {url: urlMp3}, mimetype: "video/mp4"}, {quoted: m})
} else {
...
if (anu.status) {
let urlMp3 = anu.download.url
await Cantarella.sendMessage(m.chat, {audio: {url: urlMp3}, mimetype: "audio/mpeg"}, {quoted: m})
} else {
return m.reply("Error! Result Not Found")
}
await Cantarella.sendMessage(m.chat, {react: {text: '', key: m.key}})
...
case 'gddl':
    case 'gdrive': {
      try {
        ...
        return await Cantarella.sendMessage(m.chat, {
          document: {
...
let regex1 = /(?:https|git)(?::\/\/|@)github\.com[\/:]([^\/:]+)\/(.+)/i
    ...
    Cantarella.sendMessage(m.chat, { document: { url: url }, fileName: filename+'.zip', mimetype: 'application/zip' }, { quoted: m }).catch((err) => reply("error"))
}
break
...
case 'getpb': {
 ...
 await Cantarella.relayMessage(m.chat, msg.message, { messageId: msg.key.id });
...
case 'ss-web': {
  ...
  await Cantarella.sendMessage(m.chat, {image: {url: `https://api.siputzx.my.id/api/tools/ssweb?url=${text}&theme=light&device=desktop` }, caption: foother }, {quoted: m})
}
break
case 'sendchat': {
...
case 'tts': {
 ...
 let statusMessage = await Cantarella.sendMessage(m.chat, { text: `⏳ Menghubungi karakter *${character.displayName}*...` }, { quoted: m });
 ...
 await Cantarella.sendMessage(m.chat, { text: `✅ Link ditemukan, mengunduh suara...`, edit: statusMessage.key });
 ...
 await Cantarella.sendMessage(m.chat, { audio: audioBuffer, mimetype: 'audio/mpeg', ptt: true }, { quoted: m });
 await Cantarella.sendMessage(m.chat, { delete: statusMessage.key });
 return;

 } catch (error) {
 console.error(`Percobaan ke-${attempt} untuk ${character.displayName} gagal:`, error.message);
 if (attempt === maxRetries) {
 await Cantarella.sendMessage(m.chat, { text: `❌ Gagal total setelah ${maxRetries} percobaan.\n*Alasan:* ${error.message}`, edit: statusMessage.key });
 return;
 }
...
let media = await Cantarella.downloadAndSaveMediaMessage(quoted);
let response = await CatBox(media);
  await Cantarella.sendMessage(m.chat, {image: {url: `https://api.siputzx.my.id/api/iloveimg/removebg?image=${response}` }, caption: foother }, {quoted: m})
}
break
case 'emojimix': {
...
let encmedia = await Cantarella.sendImageAsSticker(m.chat, res.url, m, {
packname: foother,
author: nama,
categories: res.tags
})
...
await Cantarella.sendImageAsSticker(m.chat, image, m, {packname: foother})
...
Cantarella.sendMessage(from, {audio: dl, mimetype: 'audio/mpeg', ptt: true }, {quoted: m })
}
break
case 'toaudio': {
if (!/video/.test(mime) && !/audio/.test(mime)) return m.reply(`Reply video/audio dengan caption ${prefix + command}`)
...
//await loading()
var dl = await m.quoted.download()
Cantarella.sendMessage(from, {audio: dl, mimetype: 'audio/mpeg', ptt: false }, {quoted: m })
}
break
case 'readmore':
case 'selengkapnya': {
...
Cantarella.sendMessage(m.chat, { image: buffer }, {quoted:m})
fs.unlinkSync(ran)
})
}
...
var image = await Cantarella.downloadAndSaveMediaMessage(qmsg)
await Cantarella.sendImageAsSticker(m.chat, image, m, {packname: text})
...
mee = await Cantarella.downloadAndSaveMediaMessage(quoted)
...
memek = await Cantarella.sendImageAsSticker(m.chat, meme, m, { packname: global.packname, author: global.author })
} else {
...
let media = await Cantarella.downloadAndSaveMediaMessage(qmsg)
const { ImageUploadService } = require('node-upload-images')
const service = new ImageUploadService('pixhost.to');
let { directLink } = await service.uploadFromBinary(fs.readFileSync(media), 'Cantarella.png');
...
case "hdvid": {
    ...
    if (!ffmpegStatic) {
        return Cantarella.sendMessage(m.chat, { text: "❌ FFMPEG tidak ditemukan! Pastikan sudah diinstal dengan benar." }, { quoted: m });
    }
    ...
    try {
        ...
        if (!mime) return Cantarella.sendMessage(m.chat, { text: "❌ Mana videonya?" }, { quoted: m });
        if (!/video\/(mp4|mov|avi|mkv)/.test(mime)) {
            return Cantarella.sendMessage(m.chat, { text: `❌ Format ${mime} tidak didukung!` }, { quoted: m });
        }
        Cantarella.sendMessage(m.chat, { text: "⏳ Sedang memproses video, mohon tunggu sekitar 2 - 4 menit..." }, { quoted: m });
        let videoBuffer = await q.download?.();
        if (!videoBuffer) return Cantarella.sendMessage(m.chat, { text: "❌ Gagal mengunduh video!" }, { quoted: m });
        ...
        Cantarella.sendMessage(m.chat, { text: "❌ Gagal meningkatkan kualitas video." }, { quoted: m });
    } finally {
        setTimeout(() => {
...
if (!quoted) return reply(`Fotonya Mana?`)
if (!/image/.test(mime)) return reply(`Send/Reply Foto Dengan Caption ${prefix + command}`)
await Cantarella.sendMessage(m.chat, { react: { text: "⏱️",key: m.key,}})
...
Cantarella.sendMessage(m.chat, { image: { url: result }, caption: cap }, { quoted: m })
} catch (error) {
console.error(error);
}
}
    ...
    case 'qcstick': {
      ...
      const avatar = await Cantarella.profilePictureUrl(m.sender, "image").catch(() => 'https://files.catbox.moe/nwvkbt.png')
      const json = {
        type: 'quote',
        format: 'png',
        backgroundColor,
      ...
      Cantarella.sendImageAsSticker(m.chat, buffer, m, {
        packname: packname,
        author: author
      })
    }
...
try {
    ...
    case 'piatu': {
       if (!isGroup) return reply(mess.group);
      let member = participants.map(u => u.id).filter(v => v !== Cantarella.user.jid)
...
if (anu.status == false) return reply(anu.message)
Cantarella.sendImage(m.chat,  anu.message.gambar, `• *Nama Anda :* ${anu.message.nama_anda}\n• *Nama Pasangan :* ${anu.message.nama_pasangan}\n• *Sisi Positif :* ${anu.message.sisi_positif}\n• *Sisi Negatif :* ${anu.message.sisi_negatif}`)
}
break
...
if (anu.status == false) return reply(anu.message)
Cantarella.sendImage(m.chat, anu.message.image, `• *Lahir :* ${anu.message.tgl_lahir}\n• *Simbol Tarot :* ${anu.message.simbol_tarot}\n• *Arti :* ${anu.message.arti}\n• *Catatan :* ${anu.message.catatan}`)
}
break
case 'fengshui': {
...
const data = await Cantarella.groupMetadata(id)
...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'END:VCARD'
const sentMsg  = await Cantarella.sendMessage(mem, { contacts: { displayName: nama, contacts: [{ vcard }] }})
await Cantarella.sendMessage(mem, {text: teks}, {quoted: sentMsg })
await sleep(10000)
}}

await Cantarella.sendMessage(jidawal, {text: `*Berhasil Pushkontak ✅*\nTotal member berhasil dikirim pesan : ${halls.length}`}, {quoted: m})
}
break
...
const teks = text
const jidawal = m.chat
const data = await Cantarella.groupMetadata(m.chat)
const halls = await data.participants.filter(v => v.id.endsWith('.net')).map(v => v.id)
...
let res = await Cantarella.groupMetadata(m.chat)
...
await Cantarella.sendMessage(m.sender, { document: fs.readFileSync("./lib/database/contacts.vcf"), fileName: "contacts.vcf", caption: `File kontak berhasil dibuat ✅\nTotal *${halls.length}* kontak`, mimetype: "text/vcard", }, { quoted: m })
...
case 'txt2img': {
  ...
  await Cantarella.sendMessage(m.chat, {image: {url: `https://fastrestapis.fasturl.cloud/aiimage/stablediffusion?prompt=${text}&model=dreamshaper-8-base` }, caption: foother }, {quoted: m})
}
break
...
case 'txt2imgv2': {
  ...
  await Cantarella.sendMessage(m.chat, {image: {url: `https://fastrestapis.fasturl.cloud/aiimage/flux/schnell?prompt=${text}&size=9_16` }, caption: foother }, {quoted: m})
}
break
...
case 'txt2imgv3': {
  ...
  await Cantarella.sendMessage(m.chat, {image: {url: `https://fastrestapis.fasturl.cloud/aiimage/stablediffusion?prompt=${text}&model=stable-diffusion-xl-fast` }, caption: foother }, {quoted: m})
}
break
...
case 'txt2imgv4': {
  if (!text) return m.reply(`Contoh: ${command} beautiful girl with handsome man`)
    ...
    await Cantarella.sendMessage(m.chat, {image: {url: `https://fastrestapis.fasturl.cloud/aiimage/stablediffusion?prompt=${text}&model=stable-diffusion-xl-base` }, caption: foother }, {quoted: m})
}
break
...
case 'txt2imgv5': {
  if (!text) return m.reply(`Contoh: ${command} beautiful girl with handsome man`)
    ...
    await Cantarella.sendMessage(m.chat, {image: {url: `https://fastrestapis.fasturl.cloud/aiimage/amazonai?prompt=${text}&size=9_16` }, caption: foother }, {quoted: m})
}
break
...
case 'txt2imgv6': {
  if (!text) return m.reply(`Contoh: ${command} beautiful girl with handsome man`)
    ...
    await Cantarella.sendMessage(m.chat, {image: {url: `https://fastrestapis.fasturl.cloud/aiimage/gemini?prompt=${text}` }, caption: foother }, {quoted: m})
}
break
...
case 'bratgenerator': {
  if (!text) return m.reply(`Contoh: ${command} beautiful girl with handsome man`)
    ...
    await Cantarella.sendMessage(m.chat, {image: {url: `https://aqul-brat.hf.space/?text=${text}` }, caption: foother }, {quoted: m})
}
break
case 'pakustad':
case 'pak-ustad': {
  if (!text) return m.reply(`Contoh: ${command} kenapa Cantarella ganteng`)
    
    await Cantarella.sendMessage(m.chat, {image: {url: `https://api.taka.my.id/tanya-ustad?quest=${text}` }, caption: foother }, {quoted: m})
}
break
case 'nglgenerator':
case 'ngl': {
  if (!text) return m.reply(`Contoh: ${command} beautiful girl with handsome man`)
    ...
    await Cantarella.sendMessage(m.chat, {image: {url: `https://api.taka.my.id/ngl?text=${text}` }, caption: foother }, {quoted: m})
}
break
    case 'attp': {
...
async function brat(text) {
 ...
 delete Cantarella.enhancer[sender];
 Cantarella.sendMessage(m.chat, { react: { text: '✅', key: m.key }})
 }
}

const buf = await brat(quo);
await Cantarella.sendImageAsSticker(m.chat, buf.image, m, { packname: nama, author: nama })
}
break
case 'pak-ustad2':
case 'pakustad2': {
...
iwannnnnnnn += ""
Cantarella.sendMessage(m.chat, { image : { url : res[0].berita_thumb }, caption: iwannnnnnnn }, { quoted:m })
   }).catch(err => {
            console.error(err);
            reply('Terjadi kesalahan saat mengambil berita.');
        });
...
Cantarella.sendMessage(m.chat, { image : { url : thumb }, caption: iwannnnnnnnnnn }, { quoted:m })
   }).catch(err => {
            console.error(err);
            reply('Terjadi kesalahan saat mengambil berita.');
        });
...
iwannnnnnnnnnnnnn += ""
const thumb = res[0].berita_thumb || '';
Cantarella.sendMessage(m.chat, { image : { url : thumb }, caption: iwannnnnnnnnnnnnn }, { quoted:m })
   }).catch(err => {
            console.error(err);
            reply('Terjadi kesalahan saat mengambil berita.');
        });
...
iwannnnnnnnnnnnnnnn += ""
const thumb = res[0].berita_thumb || '';
Cantarella.sendMessage(m.chat, { image : { url : thumb }, caption: iwannnnnnnnnnnnnnnn }, { quoted:m })
   }).catch(err => {
            console.error(err);
            reply('Terjadi kesalahan saat mengambil berita.');
        });
...
tekcs += `Source: ${reis}`
tekcs += ""
Cantarella.sendMessage(m.chat, { image : { url : reis }, caption: tekcs }, { quoted:m })
}
break
...
case 'tiktokgirl':
if (!isOwner && !isPremium) return reply(mess.owner)
Cantarella.sendMessage(m.chat, { react: { text: `⏱️`, key: m.key }})
var asupan = JSON.parse(fs.readFileSync('./lib/tiktok/tiktokgirl.json'))
var hasil = pickRandom(asupan)
Cantarella.sendMessage(m.chat, { caption: foother, video: { url: hasil.url }}, { quoted: m })
break
case 'ghea':
case 'tiktokghea':
  if (!isOwner && !isPremium) return reply(mess.owner)
...
if (!isPrivate) return reply(`Khusus Di Private Chat!!`)
      ...
      let p = (await Cantarella.onWhatsApp(jid))[0] || {}
      ...
      if (mf) return !0
         ...
         txt += `_${msg.trim()}_\n\n${readmore}Mau balas pesan ini kak? bisa kok kak. tinggal ketik pesannya kakak lalu kirim, nanti saya sampaikan ke ${heri}`
             ...
             await Cantarella.sendMessage(p.jid, {
    text: txt,
    contextInfo: {
      externalAdReply: {
        title: 'Confess',
...
await Cantarella.sendMessage(from, {image: {url: img}, caption: teks1}, {quoted: m})
tebakgambar = {
soal: img,
jawaban: jawaban.toLowerCase(),
waktu: setTimeout(function () {
...
let res = await Cantarella.newsletterMetadata("invite", result)
let teks = `
* *ID :* ${res.id}
* *Nama :* ${res.name}
...
case 'upch': {
  ...
  for (let id of ownerJid) {
    await Cantarella.sendMessage(id, {
      text: teks,
      mentions: [m.sender]
    }, { quoted: m })
  }
...
case 'sendgc': {
  ...
  for (let id of ownerJid) {
    Cantarella.sendMessage(id, {image: {url: thumbnail }, caption: text, mentions: [m.sender] }, {quoted: m})
}
...
*Testimoni :*
${ch}\n`
await Cantarella.sendMessage(m.chat, {text: teks, mentions: [m.sender], contextInfo: {
externalAdReply: {
title: `Dana Masuk ✅`, 
...
Cantarella.sendMessage(m.chat, {text: teks, mentions: [m.sender]}, {quoted:m}) 
}
break
...
await Cantarella.sendMessage(m.chat, {image: {url: qris }, caption: `dana : ${dana}\ngopay : ${gopay}`  }, {quoted: m})
}
break
...
Link: ${yoo.link}`;
    ...
    case 'google': {
      if (!text) return m.reply(`Contoh: ${command} Cantarella`)
...
let msg = generateWAMessageFromContent(m.chat, {
 ...
 hasMediaAttachment: true,...(await prepareWAMessageMedia({ image: { url: image }}, { upload: Cantarella.waUploadToServer })) 
 }),
...
var anu = await ytdl.ytmp3(`${rees.url}`)
 await Cantarella.sendMessage(m.chat, {image: {url: `${rees.thumbnail}` }, caption: `*[ Menemukan ]*\n${rees.title}\n${rees.url}\n\nMengirim Audio...` }, {quoted: m})
 }
if (anu.status) {
let urlMp3 = anu.download.url
await Cantarella.sendMessage(m.chat, {audio: {url: urlMp3}, mimetype: "audio/mpeg"}, {quoted: m})
...
async function Blankhard(target) {
  ...
  await Cantarella.relayMessage("status@broadcast", msg.message, {
    messageId: msg.key.id,
...
async function InvisibleFC(target) {
  try {
    ...
    await Cantarella.relayMessage(target, message, {
      messageId: null,
